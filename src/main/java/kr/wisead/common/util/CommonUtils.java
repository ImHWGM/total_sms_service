...
public class CommonUtils {
    ...
    public static String stripTags(String strOrg) {
        ...
        str = eregiReplace("(onreset|onmove|onstop|onpaste|onstart|onresize|onrowexit|onselect|onmousewheel|" +
                ...
                "onmouseup|onresizeend|onabort|onmoveend|onmovestart|onrowenter|onsubmit|onblur)+", " ", str);
        return str;
    }
