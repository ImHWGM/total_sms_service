...
public class EventCheckResponse {
  ...
  private String badgePrintType; // 서비스 옵션 타입 (N:명찰출력, C:체크인카드)
  ...
  /** 체크인 응답 생성 */
  public static EventCheckResponse checkIn(
  ...
  /** 액션 처리 응답 생성 */
  public static EventCheckResponse action(
      String actionCode, String actionName, EventParticipantResponse participant) {
    return EventCheckResponse.builder()
        .action(actionCode)
