...
/**
 * 지갑 Lot Entity (POINT/BONUS 유효기간 관리)
 * wallet_lot 테이블 매핑
 */
@Getter
...
public class WalletLot {
     ...
     * 포인트 Lot 생성
     */
    public static WalletLot createPointLot(String userId, BigDecimal amount, LocalDate expireDate, String source) {
     ...
     * 보너스 Lot 생성
     */
    public static WalletLot createBonusLot(String userId, BigDecimal amount, LocalDate expireDate, String source) {
        return WalletLot.builder()
                .userId(userId)
                .currencyType("BONUS")
                .amount(amount)
