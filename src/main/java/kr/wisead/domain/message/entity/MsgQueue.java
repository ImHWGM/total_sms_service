...
public class MsgQueue {
  ...
  public MsgQueue(
      ...
      String fileloc5,
      Integer filesize5,
      Integer filecntCheckup,
      LocalDateTime insertTime,
      LocalDateTime requestTime,
      LocalDateTime sendTime,
      LocalDateTime reportTime,
      LocalDateTime tcprecvTime,
   ...
   * @param regId 등록자 아이디
   */
  public static MsgQueue createForSurvey(
      String msgType,
      String dstaddr,
      String callback,
      String subject,
    ...
    return MsgQueue.builder()
        ...
        .stat("0")
        .subject(
            "S".equals(msgType) ? "-" : (subject != null && !subject.isBlank() ? subject : "[설문]"))
        .text(text)
        .insertTime(now)
        .requestTime(now)
   ...
   * @param regId 등록자 아이디
   */
  public static MsgQueue createForEvent(
      String dstaddr,
      String callback,
      String subject,
      String text,
   ...
   * @param txGroupId 결제 거래 그룹 ID (환불용)
   */
  public static MsgQueue createSms(
      String dstaddr,
      String callback,
      String subject,
      String text,
   ...
   * @param txGroupId 결제 거래 그룹 ID (환불용)
   */
  public static MsgQueue createLms(
      String dstaddr,
      String callback,
      String subject,
      String text,
   ...
   * @param txGroupId 결제 거래 그룹 ID (환불용)
   */
  public static MsgQueue createMms(
      String dstaddr,
      String callback,
      String subject,
      String text,
