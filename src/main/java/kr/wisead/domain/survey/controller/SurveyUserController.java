...
public class SurveyUserController {
    ...
    public ApiResponse<SurveyUserResponse> getUserByUserKey(
    ...
    public ApiResponse<Map<String, Object>> checkGeneralAuthStatus(
            @RequestParam String authCodeUrl,
            @RequestParam String generalAuthCode) {
        Map<String, Object> status = surveyUserService.checkGeneralAuthStatus(authCodeUrl, generalAuthCode);
    ...
    public ApiResponse<SurveyUserResponse> getUserByGeneralAuthCode(
            @RequestParam String authCodeUrl,
            @RequestParam String generalAuthCode) {
        SurveyUserResponse response = surveyUserService.getUserByGeneralAuthCode(authCodeUrl, generalAuthCode);
        return ApiResponse.success(response);
    }
