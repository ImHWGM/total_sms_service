...
public class MsgResultResponse {
    ...
    @Builder
    public MsgResultResponse(Integer mseq, String msgType, String msgTypeName,
                              String dstaddr, String callback, Integer stat,
                              ...
                              String telecom, String result, String resultName,
    ...
    public static MsgResultResponse from(MsgResult entity) {
        return MsgResultResponse.builder()
                ...
                .sendType(entity.getSendTypeName())
