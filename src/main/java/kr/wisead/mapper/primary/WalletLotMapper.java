...
public interface WalletLotMapper {
     ...
     */
    List<WalletLot> selectActiveByType(@Param("userId") String userId,
     ...
     */
    List<WalletLot> selectActiveByTypeForUpdate(@Param("userId") String userId,
                                                  @Param("currencyType") String currencyType,
                                                  @Param("today") LocalDate today);
     ...
     */
    BigDecimal selectSumRemaining(@Param("userId") String userId,
                                   @Param("currencyType") String currencyType,
                                   @Param("today") LocalDate today);

    /**
     * 사용자별 모든 통화 유형 잔여 금액 합계 조회 (POINT + BONUS)
     * - 단일 쿼리로 POINT/BONUS 합계 동시 조회
     */
    List<CurrencyBalance> selectAllSumRemaining(@Param("userId") String userId,
                                                  @Param("today") LocalDate today);
     ...
     * Lot 잔여 금액 증가 (환불 시)
     */
    int addRemaining(@Param("lotSeq") Long lotSeq,
    ...
    /**
     * 합산 대상 그룹 조회 (같은 user_id + currency_type + expire_date)
     */
     ...
     * 그룹별 Lot 목록 조회
     */
    List<WalletLot> selectByGroup(@Param("userId") String userId,
                                   @Param("currencyType") String currencyType,
     ...
     * 사용자의 모든 활성 Lot 조회
     */
    List<WalletLot> selectAllActiveByUserId(@Param("userId") String userId,
                                             @Param("today") LocalDate today);

    /**
     * Lot 합산 그룹 DTO
     */
    record LotGroup(String userId, String currencyType, LocalDate expireDate, int count) {}
}