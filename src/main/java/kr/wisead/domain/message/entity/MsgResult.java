...
/**
 * 메시지 발송 이력 Entity (SMS DB - msg_result_YYYYMM) 테이블명이 월별로 동적 생성됨 (예: msg_result_202512)
 *
 * <pre>
 * STAT 상태값:
 * - 0: 전송대기
...
public class MsgResult {
  ...
  private String extCol2; // txGroupId (결제 거래 그룹 ID, 환불용) - 발송타입은 더 이상 사용 안 함
  private String extCol3; // regId (등록자 아이디)

  // 환불 처리 여부
  private String refundYn; // Y: 환불완료, N: 미환불
