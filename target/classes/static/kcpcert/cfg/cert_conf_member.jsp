<%
    ...
    String g_conf_site_cd      = "A9C3C";

    String g_conf_web_siteid   = "";

    String g_conf_ENC_KEY      = "E66DCEB95BFBD45DF9DFAEEBCB092B5DC2EB3BF0";

    String g_conf_Ret_URL = "https://qvey-test.epopkon.com/auth/phoneAuthProcMember"; // 개발서버
    //String g_conf_Ret_URL      = "http://localhost:8080/auth/phoneAuthProcMember"; // 로컬PC
