...
public class SurveyAnswer {
     ...
     * 객관식 답변 생성
     */
    public static SurveyAnswer createMultipleChoice(Integer eventSeq, Integer questionSeq,
                                                     Integer userSeq, Integer itemSeq,
                                                     String questionType, String questionTypeDetail,
                                                     String answer, String regId) {
     ...
     * 주관식 답변 생성
     */
    public static SurveyAnswer createShortAnswer(Integer eventSeq, Integer questionSeq,
                                                  Integer userSeq, String answer, String regId) {
        return SurveyAnswer.builder()
                .eventSeq(eventSeq)
                .questionSeq(questionSeq)
                .userSeq(userSeq)
     ...
     * 파일 업로드 답변 생성
     */
    public static SurveyAnswer createFileUpload(Integer eventSeq, Integer questionSeq,
                                                 Integer userSeq, String filePath, String regId) {
        return SurveyAnswer.builder()
                .eventSeq(eventSeq)
                .questionSeq(questionSeq)
                .userSeq(userSeq)
