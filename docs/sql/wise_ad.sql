-- --------------------------------------------------------
-- 호스트:                          127.0.0.1
-- 서버 버전:                        10.11.10-MariaDB - mariadb.org binary distribution
-- 서버 OS:                        Win64
...
CREATE DATABASE IF NOT EXISTS `wise_ad` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `wise_ad`;
...
) ENGINE=InnoDB AUTO_INCREMENT=5247 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='로그 테이블';
...
) ENGINE=InnoDB AUTO_INCREMENT=284 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='기업회원 테이블';

-- ========================================================
-- 3. user 테이블만 참조하는 테이블들
-- ========================================================
...
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='고객사';
...
CREATE TABLE IF NOT EXISTS `user_password_hint` (
  ...
  KEY `fk_TB_USER_HINT_TB_MANAGER1_idx` (`MNG_SEQ`),
  CONSTRAINT `fk_TB_MANAGER_PASS_HINT_TB_MANAGER1` FOREIGN KEY (`MNG_SEQ`) REFERENCES `user` (`SEQ`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='관리자 암호 힌트';
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='개인정보/설문 마스터 테이블';

-- ========================================================
-- 5. survey_master 참조 테이블들
-- ========================================================
...
) ENGINE=InnoDB AUTO_INCREMENT=3250 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='QR 코드 방문 로그 테이블';
...
) ENGINE=InnoDB AUTO_INCREMENT=863 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='개인정보/설문 문항 테이블';
...
) ENGINE=InnoDB AUTO_INCREMENT=509 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='회원 테이블';

-- ========================================================
-- 6. survey_question 참조 테이블
-- ========================================================
...
) ENGINE=InnoDB AUTO_INCREMENT=1281 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='개인정보/설문 항목 테이블';

-- ========================================================
-- 7. survey_question, survey_item, survey_user 참조 테이블
-- ========================================================
...
) ENGINE=InnoDB AUTO_INCREMENT=406 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='개인정보/설문 응답(답변) 테이블';

-- ========================================================
-- 8. survey_master, survey_user 참조 테이블
-- ========================================================
...
) ENGINE=InnoDB AUTO_INCREMENT=229 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='간편인증번호 매핑 테이블';
