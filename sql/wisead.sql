...
CREATE TABLE IF NOT EXISTS `survey_master` (
    ...
    `MANAGER_SEQ` int(10) unsigned NOT NULL,
  ...
  KEY `fk_TB_SURVEY_MASTER_TB_COMPANY1_idx` (`MANAGER_SEQ`),
  CONSTRAINT `fk_TB_SURVEY_MASTER_TB_COMPANY1` FOREIGN KEY (`MANAGER_SEQ`) REFERENCES `user` (`SEQ`)
