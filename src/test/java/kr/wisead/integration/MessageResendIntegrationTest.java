 ...
 * - TC2.2.7: Resend with insufficient balance (PENDING - requires balance
 * integration)
...
class MessageResendIntegrationTest {
        ...
        void TC2_2_3_resendSingle_UserNotFound_Returns404() throws Exception {
                ...
                when(messageSendService.resendSurveyMessage(
                                ...
                                eq("01012345678"),
                                eq(true),
                                anyString())).thenThrow(new kr.wisead.common.exception.BusinessException(
        ...
        void TC2_2_4_resendBatch_Success() throws Exception {
                ...
                when(messageSendService.resendSurveyMessageBatch(
                                ...
                                eq("01012345678"),
                                eq(false),
                                anyString())).thenReturn(ResendResponse.success(3));
        ...
        void TC2_2_5_resendBatch_PartialSuccess() throws Exception {
                ...
                when(messageSendService.resendSurveyMessageBatch(
                                ...
                                eq("01012345678"),
                                eq(false),
                                anyString())).thenReturn(ResendResponse.partial(2, 1, List.of("99999")));
        ...
        void TC2_2_11_resendDuplicate_WithReplacementChars_Success() throws Exception {
                ...
                // values
                verify(messageSendService).resendToDuplicates(argThat(req -> req.getDuplicateReceivers() != null &&
                                req.getDuplicateReceivers().size() == 1 &&
                                "Kim Cheolsu".equals(req.getDuplicateReceivers().get(0).getRepChar01()) &&
                                "ABC123".equals(req.getDuplicateReceivers().get(0).getRepChar02())), anyString());
        }
}