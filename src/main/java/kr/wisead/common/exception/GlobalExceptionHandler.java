...
public class GlobalExceptionHandler {
  ...
  /** Rate limit 초과 예외 처리 (429) */
  @ExceptionHandler(kr.wisead.common.ratelimit.RateLimitExceededException.class)
  public ResponseEntity<ApiResponse<Void>> handleRateLimitExceededException(
      kr.wisead.common.ratelimit.RateLimitExceededException e) {
