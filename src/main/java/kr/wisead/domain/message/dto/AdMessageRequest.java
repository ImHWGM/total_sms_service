...
public class AdMessageRequest {
    ...
    public static class Recipient {
        ...
        @Builder
        public Recipient(String recPhone, String contTxt, String repChar01, String repChar02, String repChar03) {
    ...
    @Builder
    public AdMessageRequest(String reqType, String messageTypeIs, String reqNum, String sendTtl,
                            String sendTimeType, LocalDateTime reqDate, String delDuplicateNum,
                            String contTxt, List<Recipient> recipients,
    ...
    public boolean isImmediate() {
        return "direct".equals(sendTimeType) || reqDate == null ||
