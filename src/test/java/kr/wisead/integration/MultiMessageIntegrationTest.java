...
class MultiMessageIntegrationTest {
    ...
    void TC2_4_1_sendSms_Success() throws Exception {
        ...
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.success(2, 0, 0, "20260114-123456789", new BigDecimal("28.6")));
    ...
    void TC2_4_2_sendLms_Success() throws Exception {
        ...
        // Mock service
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.success(1, 0, 0, "20260114-123456790", new BigDecimal("36.3")));
    ...
    void TC2_4_3_sendMms_Success() throws Exception {
        ...
        // Mock service
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.success(1, 0, 0, "20260114-123456791", new BigDecimal("110.0")));
    ...
    void TC2_4_5_send_DuplicateRemoval() throws Exception {
        ...
        MultiMessageRequest request = MultiMessageRequest.builder()
                ...
                .receivers(List.of(
                        ...
                        MultiMessageRequest.ReceiverInfo.builder().phone("01033334444").build()
                ))
                .build();

        // Mock service - should return 2 successful, 1 duplicate
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.success(2, 1, 0, "20260114-123456792", new BigDecimal("28.6")));
    ...
    void TC2_4_6_send_BlockedNumberFiltering() throws Exception {
        ...
        MultiMessageRequest request = MultiMessageRequest.builder()
                ...
                .receivers(List.of(
                        MultiMessageRequest.ReceiverInfo.builder().phone("01011112222").build(),
                        MultiMessageRequest.ReceiverInfo.builder().phone("01055556666").build()  // Blocked number
                ))
                .build();

        // Mock service - 1 sent, 1 blocked
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.success(1, 0, 1, "20260114-123456793", new BigDecimal("14.3")));
    ...
    void TC2_4_7_send_NightTimeRestriction() throws Exception {
        ...
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.error("야간 전송제한 시간입니다. (20:00 ~ 09:00)\n해당 시간에는 예약발송만 가능합니다."));
    ...
    void TC2_4_8_send_ReplacementCharacters() throws Exception {
        ...
        // Mock service
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.success(1, 0, 0, "20260114-123456794", new BigDecimal("14.3")));
        ...
        verify(multiMessageService).sendDirectMessage(argThat(req ->
                req.getReceivers().get(0).getRepChar01().equals("홍길동") &&
    ...
    void TC2_4_9_send_ReservedSend() throws Exception {
        ...
        // Mock service
        when(multiMessageService.sendDirectMessage(any(MultiMessageRequest.class), eq("testuser")))
                .thenReturn(MultiMessageResponse.success(1, 0, 0, "20260114-123456795", new BigDecimal("14.3")));
        ...
        verify(multiMessageService).sendDirectMessage(argThat(req ->
                "reserve".equals(req.getReqType()) &&
                "2026-01-15 10:00:00".equals(req.getReqDate())
        ), eq("testuser"));
    }
    ...
    void TC2_4_15_responseFactoryMethods() {
        ...
        MultiMessageResponse successResponse = MultiMessageResponse.success(5, 2, 1, "batch123", new BigDecimal("100.0"));
