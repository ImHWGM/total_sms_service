...
CREATE TABLE IF NOT EXISTS `user_password_hint` (
  ...
  KEY `fk_USER_HINT_MANAGER1_idx` (`MNG_SEQ`),
  CONSTRAINT `fk_MANAGER_PASS_HINT_MANAGER1` FOREIGN KEY (`MNG_SEQ`) REFERENCES `user` (`SEQ`)
...
CREATE TABLE IF NOT EXISTS `survey_master` (
  ...
  KEY `fk_SURVEY_MASTER_COMPANY1_idx` (`MANAGER_SEQ`),
  CONSTRAINT `fk_SURVEY_MASTER_COMPANY1` FOREIGN KEY (`MANAGER_SEQ`) REFERENCES `user` (`SEQ`)
