...
class UserAuthIntegrationTest {
        ...
        void TC1_5_1_getMyInfo_AuthenticatedUser_ReturnsUserInfo() throws Exception {
                ...
                // Mock: UserService 응답
                kr.wisead.domain.user.dto.UserResponse expectedResponse = kr.wisead.domain.user.dto.UserResponse
                                .builder()
                                .seq(1L)
                                .userId(TEST_USER_ID)
                                .corpName("테스트기업")
        ...
        void TC1_7_1_findId_ValidInfo_ReturnsEmailAndMaskedId() throws Exception {
                ...
                kr.wisead.domain.user.dto.FindIdRequest findIdRequest = kr.wisead.domain.user.dto.FindIdRequest
                                .builder()
                                .corpName("테스트기업")
                                .person("홍길동")
                                .phone("010-2345-6789")
                ...
                kr.wisead.domain.user.dto.FindIdResponse step1Response = kr.wisead.domain.user.dto.FindIdResponse
                                .requestSuccess("te***@example.com");
                ...
                kr.wisead.domain.email.dto.EmailVerificationRequest verifyRequest = kr.wisead.domain.email.dto.EmailVerificationRequest
                                .builder()
                                .email("test@example.com")
                                .code("123456")
                                .build();
                ...
                kr.wisead.domain.user.dto.FindIdResponse step2Response = kr.wisead.domain.user.dto.FindIdResponse
                                .verifySuccess("tes*****");
        ...
        void TC1_7_2_findId_UserNotFound_ReturnsNotFoundResponse() throws Exception {
                ...
                // Mock: 사용자 없음 응답
                kr.wisead.domain.user.dto.FindIdResponse notFoundResponse = kr.wisead.domain.user.dto.FindIdResponse
                                .accountNotFound();
                when(userService.requestFindId(any(kr.wisead.domain.user.dto.FindIdRequest.class)))
        ...
        void TC1_7_3_findId_InvalidCode_ReturnsVerificationFailed() throws Exception {
                ...
                // Mock: 인증 실패 응답
                kr.wisead.domain.user.dto.FindIdResponse failedResponse = kr.wisead.domain.user.dto.FindIdResponse
                                .verificationFailed();
        ...
        void TC1_8_1_findPassword_ValidInfo_SendsResetEmail() throws Exception {
                ...
                kr.wisead.domain.user.dto.FindPasswordResponse successResponse = kr.wisead.domain.user.dto.FindPasswordResponse
                                .success("te***@example.com");
        ...
        void TC1_8_2_findPassword_AccountNotFound_ReturnsNotFoundResponse() throws Exception {
                ...
                // Mock: 계정 없음 응답
                kr.wisead.domain.user.dto.FindPasswordResponse notFoundResponse = kr.wisead.domain.user.dto.FindPasswordResponse
                                .accountNotFound();
                when(userService.findPassword(any(kr.wisead.domain.user.dto.FindPasswordRequest.class)))
                                .thenReturn(notFoundResponse);
        ...
        void TC1_8_3_findPassword_HintMismatch_ReturnsHintMismatchResponse() throws Exception {
                ...
                // Mock: 힌트 불일치 응답
                kr.wisead.domain.user.dto.FindPasswordResponse hintMismatchResponse = kr.wisead.domain.user.dto.FindPasswordResponse
                                .hintMismatch();
                when(userService.findPassword(any(kr.wisead.domain.user.dto.FindPasswordRequest.class)))
        ...
        void TC1_8_5_passwordReset_ValidToken_ChangesPassword() throws Exception {
                // Given: 비밀번호 재설정 요청
                kr.wisead.domain.user.dto.PasswordResetConfirmRequest request = new kr.wisead.domain.user.dto.PasswordResetConfirmRequest();
                request.setToken("valid-uuid-token-12345");
                request.setNewPassword("NewPassword123!");

                // Mock: 비밀번호 변경 성공
                doNothing().when(userService).resetPasswordWithToken(eq("valid-uuid-token-12345"),
                                eq("NewPassword123!"));
                ...
                verify(userService, times(1)).resetPasswordWithToken(eq("valid-uuid-token-12345"),
                                eq("NewPassword123!"));
        }
