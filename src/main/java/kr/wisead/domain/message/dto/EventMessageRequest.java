...
public class EventMessageRequest {
    ...
    /**
     * 발송 유형
     * IMMEDIATE: 즉시발송 (QR링크 직접 발송)
     * SELECTIVE: 선택발송 (접속링크 발송 → 참석 확인 시 QR 노출)
     * REVIEW: 검토발송 (접속링크 발송 → 인증정보 입력 → 2차 QR 발송)
     */
    ...
    @Builder
    public EventMessageRequest(Integer eventSeq, String callback, String subject, String text,
                                String sendType, List<Receiver> receivers,
                                LocalDateTime requestTime, boolean delDuplicateNum,
                                String eventName, String eventPeriod, String eventLocation) {
    ...
    public static class Receiver {
        ...
        @Builder
        public Receiver(String phone, Long participantSeq, Integer surveyUserSeq,
                        String checkCode, String name, String qrLink, String accessLink,
