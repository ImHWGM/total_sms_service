...
public class UserController {
  ...
  /** 아이디 찾기 1단계 - 정보 검증 및 이메일 인증코드 발송 POST /api/users/find-id/request */
  ...
  /** 아이디 찾기 2단계 - 인증코드 검증 및 아이디 반환 POST /api/users/find-id/verify */
  @PostMapping("/find-id/verify")
  public ApiResponse<FindIdResponse> verifyAndGetUserId(
  ...
  /** 비밀번호 초기화 (관리자용) PUT /api/users/{userId}/password/reset */
  ...
  /** 계정 잠금 해제 (관리자용) PUT /api/users/{userId}/unlock */
  ...
  /** 비밀번호 찾기 (힌트 기반 + 이메일 링크 발송) POST /api/users/find-pw */
  @PostMapping("/find-pw")
  ...
  /** 비밀번호 재설정 토큰 유효성 검증 GET /api/users/password/reset-validate?token=xxx */
  ...
  /** 비밀번호 재설정 확인 (새 비밀번호 설정) POST /api/users/password/reset-confirm */
  @PostMapping("/password/reset-confirm")
  public ApiResponse<Void> resetPasswordWithToken(
  ...
  /** 회원 정보 수정 (기업 정보) - 관리자 전용 PUT /api/users/{seq}/info */
  @PutMapping("/{seq}/info")
  @PreAuthorize("hasRole('ADMIN')")
